...
SUITES = ["smoke_test", "refresh_test", "offline_test", "admin_test", "generator_test", "frontend_static", "integration_test", "curriculum_test", "stats_test", "security_test", "billing_test", "licensing_test", "blueprint_test"]
