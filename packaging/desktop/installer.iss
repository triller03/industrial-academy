; AI-Powered Industrial Academy - Windows desktop installer
; Built by packaging/desktop/build-desktop.ps1 (Inno Setup 6, per-user install).

#define MyAppName "AI-Powered Industrial Academy"
...
OutputBaseFilename=IndustrialAcademy-Setup-{#MyAppVersion}
Compression=lzma2
