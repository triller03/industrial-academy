...
![ASAP.A](packaging/desktop/assets/asapa_lockup.png)

*ASAP.A (ASAP Automation) — formerly the AI-Powered Industrial Academy — is an*
...
For a native, browser-less experience the platform is also packaged as the **ASAP.A Windows desktop
...
port 502. The app icon and installer icon use the ASAP.A mark (assets generated by
...
- `packaging/desktop/dist-desktop/ASAP.A-Setup-1.0.0.exe` (~24 MB, per-user installer → Start Menu +
